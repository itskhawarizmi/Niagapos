...
{ /// <summary>
  ...
  /// </summary>
    public static class StoryboardHelpers
    {
        ...
        /// <summary>
        /// Adds a slide from left animation to storyboard
        /// </summary>
        ...
        /// <summary>
        /// Adds a slide to left animation to storyboard
        /// </summary>
        /// <param name="storyboard">The storyboard to add the animation</param>
        /// <param name="seconds">The time the animation will take</param>
        /// <param name="offset">The distance to the left to start from</param>
        ...
        /// <summary>
        /// Add slide from top to the storyboard
        /// </summary>
        /// <param name="storyboard">The storyboard to add the animation</param>
        /// <param name="seconds">The time the animation will take</param>
        /// <param name="offset">The distance to the top to start from</param>
        /// <param name="decelerationRatio">The rate of deelaration</param>
        /// <param name="keepMargin">Whether to keep the element at the same width during animation</param>
        ...
        /// <summary>
        /// Adds slide from bottom to the storyboard
        /// </summary>
        /// <param name="storyboard">The storyboard to add the animation</param>
        /// <param name="seconds">The time the animation will take</param>
        ...
        /// <summary>
        /// Adds slide to bottom animation to the storyboard
        /// </summary>
        /// <param name="storyboard">The storyboard to add the animation</param>
        /// <param name="seconds">The time the animation will take</param>
        ...
        /// <summary>
        /// Adds a fade out in animation to the storyboard
        /// </summary>
        /// <param name="storyboard">The storyboard to add the animation to</param>
        /// <param name="seconds">The time the animation will take</param>
        ...
        /// <param name="offset">The inner content size, to start the marquee as soon as that content has scrolled out of view</param>
        /// <param name="contentOffset">The offset of the parent to scroll within</param>
