 ...
 * Support By: Luke Malpas! Thank you :)    *
 ********************************************/
...
namespace Niagapos
{
    ...
    public class WindowResizer
    {
        ...
        /// <summary>
        /// How close to the edge the window has to be detected as at the edge of the screen.
        /// </summary>
        ...
        private void Window_SourceInitialized(object sender, EventArgs e)
        {
            ...
            // Hook into it's Window messages
        ...
        private void Window_SizeChanged(object sender, SizeChangedEventArgs e)
        {
            ...
            var windowTopLeft = new Point(left * mMonitorDpi.Value.DpiScaleX, top * mMonitorDpi.Value.DpiScaleY);
            var windowBottomRight = new Point(right * mMonitorDpi.Value.DpiScaleX, bottom * mMonitorDpi.Value.DpiScaleY);
        ...
        // This point for cursor position.
        public struct POINT
        {
            /// <summary>
